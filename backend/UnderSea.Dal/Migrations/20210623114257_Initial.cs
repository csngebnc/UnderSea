        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    effect_type = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MercenaryPerRound = table.Column<int>(type: "int", nullable: false),
                    SupplyPerRound = table.Column<int>(type: "int", nullable: false),
                    Price = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pearl = table.Column<int>(type: "int", nullable: false),
                    Coral = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Countries_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuildingEffects", x => new { x.BuildingId, x.EffectId });
                    table.ForeignKey(
                        name: "FK_BuildingEffects_Buildings_BuildingId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UpgradeEffects", x => new { x.EffectId, x.UpgradeId });
                    table.ForeignKey(
                        name: "FK_UpgradeEffects_Effects_EffectId",
                        column: x => x.EffectId,
                        principalTable: "Effects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UpgradeEffects_Upgrades_UpgradeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AttackRound = table.Column<int>(type: "int", nullable: false),
                    WinnerId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    AttackerCountryId = table.Column<int>(type: "int", nullable: false),
                    DefenderCountryId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Attacks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Attacks_AspNetUsers_WinnerId",
                        column: x => x.WinnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Count = table.Column<int>(type: "int", nullable: false),
                    BonusAttackPoint = table.Column<int>(type: "int", nullable: false),
                    BonusDefensePoint = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CountryUnits", x => new { x.CountryId, x.UnitId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CountryUpgrades", x => new { x.CountryId, x.UpgradeId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttackUnits", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "ActiveConstructions",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EstimatedFinish = table.Column<int>(type: "int", nullable: false),
                    CountryBuildingId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActiveConstructions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ActiveConstructions_CountryBuildings_CountryBuildingId",
                        column: x => x.CountryBuildingId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attacks_AttackerCountryId",
                table: "Attacks",
                column: "AttackerCountryId");

            migrationBuilder.CreateIndex(
                name: "IX_Attacks_DefenderCountryId",
                table: "Attacks",
                column: "DefenderCountryId");

            migrationBuilder.CreateIndex(
                name: "IX_Attacks_WinnerId",
                table: "Attacks",
                column: "WinnerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UpgradeEffects_UpgradeId",
